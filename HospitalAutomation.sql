...
--
-- Host: localhost
-- Generation Time: Jun 14, 2015 at 08:47 AM
...
INSERT INTO `takenappointments` (`takedappointmentid`, `clinicname`, `clinicplace`, `date`, `doctorid`, `hospitalname`, `hour`, `patientid`) VALUES
(1, 'Genel Cerrahi', 'Merkez', '2015-06-14', 1, 'Eyüp Devlet Hastanesi', '10:00', '11111111111');
...
--
ALTER TABLE `RANDEVUSAATLERI`
  MODIFY `SAATID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `takenappointments`
--
ALTER TABLE `takenappointments`
  MODIFY `takedappointmentid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `uygunrandevular`
  MODIFY `uygunrandevuid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
